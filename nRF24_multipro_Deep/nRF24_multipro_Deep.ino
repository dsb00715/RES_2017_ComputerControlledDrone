...
//#define MOSI_pin  12  // MOSI - D3
//#define SCK_pin   13  // SCK  - D4
//#define CE_pin    8  // CE   - D5
//#define MISO_pin  11 // MISO - A0
...
// SPI outputs
/*
#define MOSI_on digitalWrite(MOSI_pin,HIGH)  // PD3
#define MOSI_off digitalWrite(MOSI_pin,LOW)// PD3
#define SCK_on digitalWrite(SCK_pin,HIGH)   // PD4
#define SCK_off digitalWrite(SCK_pin,LOW) // PD4
#define CE_on digitalWrite(CE_pin,HIGH)    // PD5
#define CE_off digitalWrite(CE_pin,LOW)  // PD5
#define CS_on digitalWrite(CS_pin,HIGH)    // PC1
#define CS_off digitalWrite(CS_pin,LOW)  // PC1
// SPI input
#define  MISO_on digitalRead(MISO_pin) // PC0
*/
...
char *p, *i;
char* c = new char[200 + 1]; // match 200 characters reserved for inputString later c=&c[0]
char* errpt;
uint8_t ppm_cnt;
...
void init_protocol()
{
    switch(current_protocol) {
        ...
        case PROTO_E010:
            MJX_init();
            MJX_bind();
			Serial.println("E010-initialized and bound");
            break;
    }
}
