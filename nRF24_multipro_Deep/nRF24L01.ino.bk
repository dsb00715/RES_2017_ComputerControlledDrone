...
{
    CS_off;
    uint8_t data = spi_read_address(R_REGISTER | ( REGISTER_MASK & reg ));
    CS_on;
    return data;
}
...
void NRF24L01_SetTxRxMode(enum TXRX_State mode)
{
    if(mode == TX_EN) {
        CE_off;
        uint8_t res = (1 << NRF24L01_07_RX_DR)    //reset the flag(s)
                                            | (1 << NRF24L01_07_TX_DS)
                                            | (1 << NRF24L01_07_MAX_RT);
                                            
        Serial.print("NRF24L01_07_STATUS WR: ");
        Serial.println(res);
        ...
        res = NRF24L01_ReadReg(NRF24L01_07_STATUS);
        Serial.print("NRF24L01_07_STATUS RD: ");
        Serial.println(res);
